...
export default function NewFurnitureTypePage() {
    ...
    const onSubmit = async (data: TypeFormData) => {
        try {
            ...
            if (result.success) {
                toast({ title: "Success", description: "Furniture type created successfully" });
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-3xl font-bold tracking-tight font-heading uppercase">Add Furniture Type</h2>
                        </div>
                        <p className="text-muted-foreground">Define a new furniture category</p>
                    </div>
                </div>
            </div>

            <div className="mx-auto">
                <TypeForm type="furniture" onSubmit={onSubmit} isLoading={loading} />
            </div>
        </div>
    );
}
